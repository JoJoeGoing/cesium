 ...
 * var tms = new Cesium.CustormImageryProvider({
 ...
 * var positron = new Cesium.CustormImageryProvider({
 *     url : 'http://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png',
 *     credit : 'Map tiles by CartoDB, under CC BY 3.0. Data by OpenStreetMap, under ODbL.'
 * });
 * // Access a Web Map Service (WMS) server.
 * var wms = new Cesium.CustormImageryProvider({
 ...
 * var custom = new Cesium.CustormImageryProvider({
 ...
 */
function CustormImageryProvider(options) {
...
defineProperties(CustormImageryProvider.prototype, {
    /**
 ...
 */
CustormImageryProvider.prototype.reinitialize = function(options) {
    var that = this;
 ...
 */
CustormImageryProvider.prototype.getTileCredits = function(x, y, level) {
    //>>includeStart('debug', pragmas.debug);
    if (!this.ready) {
 ...
 */
CustormImageryProvider.prototype.requestImage = function(x, y, level, request) {
    //>>includeStart('debug', pragmas.debug);
    if (!this.ready) {
 ...
 */
CustormImageryProvider.prototype.pickFeatures = function(x, y, level, longitude, latitude) {
    //>>includeStart('debug', pragmas.debug);
    if (!this.ready) {
